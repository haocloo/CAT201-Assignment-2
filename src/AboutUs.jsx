...
const AboutUs = () => {
  return (
    <div
      id="AboutUs"
      className="flex flex-col-reverse lg:flex-row-reverse w-full "
    >
      <div className="flex flex-col justify-center gap-3 lg:gap-7 lg:h-[100vh] p-10 pb-0 lg:p-14 lg:pb-0 w-full lg:w-1/2 text-left">
